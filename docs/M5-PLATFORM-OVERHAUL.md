...
```bash
npx supabase db push        # applies the 49 pending migrations, in version order
...
sixty-eight rather than from the incremental path; the database suite is the one
