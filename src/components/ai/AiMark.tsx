 ...
 * Inline rather than imported so the drawn state costs no component and no
 * chunk, and so `scripts/bake-openai-mark.cjs` and this file can be read
 * against each other — they must stay the same artwork.
 */
const OPENAI_PATH =
