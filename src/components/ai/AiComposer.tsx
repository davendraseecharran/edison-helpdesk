  ...
  function AiComposer(
    ...
    useLayoutEffect(() => {
      ...
      field.style.overflowY =
        field.scrollHeight > MAX_HEIGHT ? "auto" : "hidden";
    }, [value]);
      ...
      >
        {page ? (
          <div className="ai-composer-context">
            ...
            <span>
              Working on{" "}
              <span className={page.kind === "person" ? undefined : "mono"}>
                {page.label}
              </span>
            </span>
          </div>
        ...
        {images.length > 0 ? (
          <ul
            ...
            aria-label="Pictures attached to this message"
          >
            {images.map((image) => (
                ...
                {canAttach ? (
                  <>
                    ...
                    <button
                      ...
                      title={
                        full
                          ? `Up to ${MAX_IMAGES} pictures in one message`
                          : "Add a picture"
                      }
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      {reasoningOptions.map((option) => (
                        <DropdownMenuItem
                          key={option.value}
                          onSelect={() => onReasoning(option.value)}
                        >
                          {option.label}
